...
module.exports = {
  ...
  async handle(interaction) {
    ...
    if (!instance) {
      return await interaction.reply({
        content: '笞・・蟇ｾ雎｡縺ｮ險ｭ鄂ｮ繝・・繧ｿ縺瑚ｦ九▽縺九ｊ縺ｾ縺帙ｓ縲・,
        flags: MessageFlagsBitField.Ephemeral,
      });
    }
    ...
    try {
      ...
      const button = new ButtonBuilder()
        .setCustomId(`totsusuna:report:${uuid}`) // 邨ｱ荳蜻ｽ蜷崎ｦ丞援縺ｫ蜷医ｏ縺帙ｋ
        .setLabel('蜃ｸ繧ｹ繝雁ｱ蜻・)
      ...
      await interaction.reply({
        content: '豆 蜀埼∽ｿ｡縺励∪縺励◆縲りｨｭ鄂ｮ繝√Ε繝ｳ繝阪Ν縺ｫ謚慕ｨｿ縺輔ｌ縺ｾ縺励◆縲・,
        flags: MessageFlagsBitField.Ephemeral,
      });
